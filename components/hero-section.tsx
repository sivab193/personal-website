...
export function HeroSection() {
  ...
  const fullText = "Full-Stack & Data Engineer"
      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 animate-fade-in">
          <div className="space-y-2">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-slate-100">Sivaganesh Balaganesh</h1>
          ...
          <p className="text-slate-300 text-lg leading-relaxed max-w-xl">
            MS Computer Science student at Purdue University with 2+ years of experience building scalable data
            platforms and full-stack applications. Previously Senior Software Engineer at Visa, specializing in data
            engineering and privacy solutions.
          </p>
